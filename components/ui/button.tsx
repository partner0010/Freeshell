...
const variantClasses: Record<ButtonVariant, string> = {
  ...
  outline:
    "border-2 border-primary-500 text-primary-600 hover:bg-primary-50 active:bg-primary-100 disabled:text-neutral-400 disabled:border-neutral-200",
  default: "bg-primary-500 text-white hover:bg-primary-600 active:bg-primary-700 disabled:bg-primary-400/60 disabled:text-white/80",
